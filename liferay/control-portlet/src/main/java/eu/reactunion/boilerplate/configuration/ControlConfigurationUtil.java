...
import static eu.reactunion.boilerplate.constants.ControlConstants.*;
 ...
 */
public class ControlConfigurationUtil {
    ...
    public static void addConfigurationContext(RenderRequest request) throws ConfigurationException {
        ...
        if (themeDisplay != null) {
            ControlConfiguration ContentConfiguration = getContentConfiguration(themeDisplay);
    ...
    private static ControlConfiguration getContentConfiguration(ThemeDisplay themeDisplay) throws ConfigurationException {
        final PortletDisplay portletDisplay = themeDisplay.getPortletDisplay();
        return portletDisplay.getPortletInstanceConfiguration(ControlConfiguration.class);
    }
